...
contribution line, but the new `Enable Movement contribution` kill switch is
...
until signed-event and reconciliation dependencies pass their gates. See
`extensions/fep-cart-match/README.md` for the synthetic G0 lab, product
configuration, and the full acceptance test.
